...
(function(m, oa) {
	...
	function Zb(a, b) {
														...
														function(ra, sa) {
															if (sa == "title") {
																...
																if (ha) {
																	...
																	var da = jb(
																			b.buttonText,
																			sa), ma = m("<span class='fc-button fc-button-"
																			+ sa
																			+ " "
																			+ q
		...
		function g(u) {
			Q
					.find("h2")
					.html(u.substring(3, 8) + '년 ' + u.substring(0, 3)/*
																		 * 9월
																		 * 2011년
																		 */)
		}
	...
	function $b(a, b) {
		...
		function y(c) {
			var z, H = L.length, T, X = ma().defaultEventEnd, ya = c.start
		...
		var da = ha.trigger, ma = ha.getView, ua = ha.reportEvents, pa = {
			events : []
	...
	m.fn.fullCalendar = function(a) {
		...
		a = m.extend(true, {}, Ya, a.isRTL || a.isRTL === oa && Ya.isRTL ? xc
				: {}, a);
